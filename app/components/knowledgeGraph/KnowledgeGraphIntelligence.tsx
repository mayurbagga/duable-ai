...
export const KnowledgeGraphIntelligence: React.FC<KnowledgeGraphIntelligenceProps> = ({ className = '' }) => {
  ...
  const renderOverview = () => (
    <div className="space-y-8">
      ...
      {/* Value Proposition */}
      <Card className="p-8 bg-gradient-to-r from-blue-50 to-blue-50 dark:from-blue-900/20 dark:to-blue-900/20">
      ...
      <div className={`space-y-6 ${className}`}>
        <Card className="p-8 text-center">
          ...
          <Button variant="default" onClick={() => (window.location.href = '/')}>
            Go to Duable to Connect Wallet
          </Button>
        </Card>
      </div>
    );
