...
export const ChatBox: React.FC<ChatBoxProps> = (props) => {
  ...
  isInputFocused
    ? 'border-[#2563EB]/60 dark:border-[#2563EB]/60 shadow-[#2563EB]/20 shadow-2xl scale-[1.02] ring-4 ring-[#2563EB]/10'
      ...
      >
          ...
          <textarea
            ...
            placeholder={
              props.chatMode === 'build'
                ? "Ask Duable anything or describe what you'd like to build..."
        ...
        <div className="flex justify-between items-center px-8 py-5 bg-gradient-to-r from-gray-50/80 via-gray-50/60 to-gray-50/80 dark:from-gray-800/80 dark:via-gray-800/60 dark:to-gray-800/80 border-t border-gray-200/50 dark:border-gray-700/50 backdrop-blur-sm">
          <div className="flex gap-4 items-center">
            {/* Chat Mode Indicator */}
            <div className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-[#2563EB]/10 to-[#2563EB]/20 dark:from-[#2563EB]/20 dark:to-[#2563EB]/30 rounded-full border border-[#2563EB]/40 dark:border-[#2563EB]/60 shadow-sm hover:shadow-md transition-all duration-300">
              <div className="w-2.5 h-2.5 bg-[#2563EB] rounded-full animate-pulse shadow-sm"></div>
              <span className="text-xs font-semibold text-[#2563EB] dark:text-[#2563EB]/80 capitalize">
