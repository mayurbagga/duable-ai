...
export const SendButton = ({ show, isStreaming, disabled, onClick }: SendButtonProps) => {
  return (
    <AnimatePresence>
      {show ? (
        <motion.button
          className="relative flex justify-center items-center p-3 bg-gradient-to-r from-[#2563EB] to-[#1E4FCC] hover:from-[#1E4FCC] hover:to-[#1A42B0] text-white rounded-2xl w-12 h-12 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg hover:shadow-xl hover:shadow-[#2563EB]/25 hover:scale-105 active:scale-95 group"
