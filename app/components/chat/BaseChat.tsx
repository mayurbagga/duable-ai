    ...
    <div className="flex flex-col lg:flex-row overflow-y-auto w-full h-full">
      <div className={classNames(styles.Chat, 'flex flex-col flex-grow lg:min-w-[var(--chat-min-width)] h-full')}>
        {chatStarted ? (
          ...
          // --------------------------------
          <div className="flex bg-gradient-to-t from-[#2563EB] via-white to-white flex-col items-center justify-center h-full min-h-screen px-4 py-8">
            <div className="flex flex-col items-center justify-center flex-1 max-w-4xl mx-auto space-y-8">
              ...
              <div className={classNames(styles.WelcomeTitle, 'text-center space-y-4')}>
                <div className="flex items-center justify-center gap-4">
                  <img src="/duable_logo2.png" alt="Duable Logo" className="w-56" />
                </div>
